...
// swagger:route GET /users/{{toLower project}}s user get{{title project}}List
//
// Get the currently authenticated user's {{toLower project}} list.
//
//     Responses:
//       200: {{toLower project}}List
//
func {{toLower project}}List(w http.ResponseWriter, r *http.Request) {}
