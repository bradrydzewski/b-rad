...
import { use{{title project}}List } from "../../api/{{toLower project}}.js";
...
export default function Account({ params }) {
	...
	const { {{toLower project}}List } = use{{title project}}List();
					...
					<div className={styles.workspaces}>
						{{`{`}}{{toLower project}}List &&
							{{toLower project}}List.map(({{toLower project}}) => (
								<div>
									<Avatar text={{`{`}}{{toLower project}}.name} className={styles.avatar} />
